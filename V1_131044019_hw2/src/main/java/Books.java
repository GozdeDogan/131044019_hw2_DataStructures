...
public abstract class Books implements BookInterface {
    ...
    public boolean equals(Object o) {
        ...
        if (this.getBookName() != null && ((Books) o).getBookName() != null &&
                this.getWriterName() != null && ((Books) o).getWriterName() != null &&
                getBookName().equals(((Books) o).getBookName()) && getWriterName().equals(((Books) o).getWriterName()))
            return true;
        return false;
    }
