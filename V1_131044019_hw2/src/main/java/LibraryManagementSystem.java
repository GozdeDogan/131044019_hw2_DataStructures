...
public class LibraryManagementSystem {
    private LinkedList<Person> staffs;
    private LinkedList<Person> users;
    private LinkedList<Books> books;
     ...
     * @param books
     */
    public LibraryManagementSystem(LinkedList<Person> staffs, LinkedList<Person> users, LinkedList<Books> books) {
     ...
     * @return
     */
    public LinkedList<Person> getStaffs() {
        return staffs;
    }
     ...
     * @param staffs
     */
    public void setStaffs(LinkedList<Person> staffs) {
        this.staffs.addAll(staffs);
    }
     ...
     * @param books
     */
    public void setBooks(LinkedList<Books> books) {
        this.books.addAll(books);
    }
    /**
